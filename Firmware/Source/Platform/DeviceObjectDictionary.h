...
#define REG_DAC_I_RANGE0_P0				37	// Диапазон 0 - Коэффициент тонкой подстройки Р0
#define REG_DAC_I_RANGE0_K				38	// Диапазон 0 - Коэффициент тонкой подстройки K
#define REG_DAC_I_RANGE0_B				39	// Диапазон 0 - Коэффициент тонкой подстройки B
//
...
#define REG_DAC_I_RANGE1_P0				42	// Диапазон 1 - Коэффициент тонкой подстройки Р0
#define REG_DAC_I_RANGE1_K				43	// Диапазон 1 - Коэффициент тонкой подстройки K
#define REG_DAC_I_RANGE1_B				44	// Диапазон 1 - Коэффициент тонкой подстройки B
//
...
#define REG_DAC_I_RANGE2_P0				47	// Диапазон 2 - Коэффициент тонкой подстройки Р0
#define REG_DAC_I_RANGE2_K				48	// Диапазон 2 - Коэффициент тонкой подстройки K
#define REG_DAC_I_RANGE2_B				49	// Диапазон 2 - Коэффициент тонкой подстройки B
//
...
#define REG_DAC_I_RANGE3_P0				52	// Диапазон 3 - Коэффициент тонкой подстройки Р0
#define REG_DAC_I_RANGE3_K				53	// Диапазон 3 - Коэффициент тонкой подстройки K
#define REG_DAC_I_RANGE3_B				54	// Диапазон 3 - Коэффициент тонкой подстройки B
//
