...
//
#define REG_DAC_I_RANGE0_N				22	// Диапазон 0 - Числитель коэффициента грубой подстройки
#define REG_DAC_I_RANGE0_D				23	// Диапазон 0 - Знаменатель коэффициента грубой подстройки
#define REG_DAC_I_RANGE0_B				24	// Диапазон 0 - Смещение грубой подстройки B
//
#define REG_DAC_I_RANGE1_N				25	// Диапазон 1 - Числитель коэффициента грубой подстройки
#define REG_DAC_I_RANGE1_D				26	// Диапазон 1 - Знаменатель коэффициента грубой подстройки
#define REG_DAC_I_RANGE1_B				27	// Диапазон 1 - Смещение грубой подстройки B
//
#define REG_DAC_I_RANGE2_N				28	// Диапазон 2 - Числитель коэффициента грубой подстройки
#define REG_DAC_I_RANGE2_D				29	// Диапазон 2 - Знаменатель коэффициента грубой подстройки
#define REG_DAC_I_RANGE2_B				30	// Диапазон 2 - Смещение грубой подстройки B
//
#define REG_DAC_I_RANGE3_N				31	// Диапазон 3 - Числитель коэффициента грубой подстройки
#define REG_DAC_I_RANGE3_D				32	// Диапазон 3 - Знаменатель коэффициента грубой подстройки
#define REG_DAC_I_RANGE3_B				33	// Диапазон 3 - Смещение грубой подстройки B
// 34 - 41
