...
// 12 - 22
#define REG_DAC_V_CELL_K				23	// Ячейка 0 - Коэффициент грубой подстройки К
#define REG_DAC_V_CELL_B				24	// Ячейка 0 - Смещение грубой подстройки B
// 25 - 34
...
#define REG_DAC_I_RANGE0_K				38	// Диапазон 0 - Коэффициент грубой подстройки K
#define REG_DAC_I_RANGE0_B				39	// Диапазон 0 - Смещение грубой подстройки B
//
...
#define REG_DAC_I_RANGE1_K				43	// Диапазон 1 - Коэффициент грубой подстройки K
#define REG_DAC_I_RANGE1_B				44	// Диапазон 1 - Смещение грубой подстройки B
//
...
#define REG_DAC_I_RANGE2_K				48	// Диапазон 2 - Коэффициент грубой подстройки K
#define REG_DAC_I_RANGE2_B				49	// Диапазон 2 - Смещение грубой подстройки B
//
...
#define REG_DAC_I_RANGE3_K				53	// Диапазон 3 - Коэффициент грубой подстройки K
#define REG_DAC_I_RANGE3_B				54	// Диапазон 3 - Смещение грубой подстройки B
//
